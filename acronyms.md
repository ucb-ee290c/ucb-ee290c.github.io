...
ADE				Analog Design Environment - a Cadence tool or analog design
...
CDF				Component Description Format - a format for a cell layout in Cadence
...
CPF				Common Power Format (a Cadence and Si2 tcl-based language for specifying power intent in a chip design)
...
FSDB				Fast Signal DataBase - an open file format for waveforms
...
LEF 				Library Exchange Format – an ascii text file description of an abstract layout of a cell on a chip.  Its MACRO feature is what is pertinent.
...
MIDAS				Modeling Infrastructure for Debugging And Simulation (a Chisel library)
...
NLDM				Non Linear Delay Model - used for Static Timing Analysis
...
OD					Oxide Diffusion - mask region for transistor active area
...
PRN				Pseudo Random Number code - identifier for a GPS satellite
...
RS232				Recommended Standard 232 (a wiring standard for a serial protocol)
...
SDC				Synopsys Design Constraints (file extension for timing and area intent file)
...
TK					ToolKit - open source cross-platform widget toolkit for making GUIs for various languages
...
TSI					Tethered Serial Interface, or more commonly, Serialized TileLink
...
VCU118			a part number for a Xilinx FPGA board widely used at BWRC
